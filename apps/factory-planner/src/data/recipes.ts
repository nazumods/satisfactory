...
export const RECIPES: Recipe[] = [
  ...
  r("AI Expansion Server", "AI Expansion Server", "Quantum Encoder",
    ...
    { "AI Expansion Server": 16, "Dark Matter Residue": 128 }),
  ...
  r("Excited Photonic Matter", "Excited Photonic Matter", "Converter",
    {}, { "Excited Photonic Matter": 100 }, { power: 250 }),
  r("Dark Matter Residue (from SAM)", "Dark Matter Residue", "Particle Accelerator",
    { "Reanimated SAM": 50 }, { "Dark Matter Residue": 500 }, { power: 500 }),
  ...
  r("Superposition Oscillator", "Superposition Oscillator", "Quantum Encoder",
    ...
    { "Superposition Oscillator": 15, "Dark Matter Residue": 60 }),
  r("Neural-Quantum Processor", "Neural-Quantum Processor", "Quantum Encoder",
    ...
    { "Neural-Quantum Processor": 9, "Dark Matter Residue": 75 }),
  r("Ficsite Trigon", "Ficsite Trigon", "Constructor",
    { "Ficsite Ingot": 10 }, { "Ficsite Trigon": 15 }),
  r("Iron Ficsite Ingot", "Ficsite Ingot", "Converter",
    { "Reanimated SAM": 40, "Iron Ingot": 240 }, { "Ficsite Ingot": 10 }, { power: 250 }),
  r("Reanimated SAM", "Reanimated SAM", "Constructor",
    { SAM: 120 }, { "Reanimated SAM": 30 }),
  r("Time Crystal", "Time Crystal", "Particle Accelerator",
    { Diamond: 12 }, { "Time Crystal": 6 }, { power: 500 }),
  ...
  r("Dark Matter Crystallization", "Dark Matter Crystal", "Particle Accelerator",
    { Diamond: 30, "Dark Matter Residue": 150 }, { "Dark Matter Crystal": 30 }, { power: 500 }),
  ...
  r("Automated Wiring", "Automated Wiring", "Assembler",
    { Stator: 2.5, Cable: 50 }, { "Automated Wiring": 2.5 }),
  r("Automated Speed Wiring", "Automated Wiring", "Manufacturer",
    { Stator: 3.75, Wire: 75, "High-Speed Connector": 7.5 }, { "Automated Wiring": 7.5 }, { alt: true }),

  r("Modular Engine", "Modular Engine", "Manufacturer",
    { Motor: 2, Rubber: 15, "Smart Plating": 2 }, { "Modular Engine": 1 }),
  ...
  r("Assembly Director System", "Assembly Director System", "Assembler",
    { "Adaptive Control Unit": 1.5, Supercomputer: 0.75 }, { "Assembly Director System": 0.75 }),
  ...
  r("High-Speed Connector", "High-Speed Connector", "Manufacturer",
    { Quickwire: 210, Cable: 37.5, "Circuit Board": 3.75 }, { "High-Speed Connector": 3.75 }),
  r("Silicon High-Speed Connector", "High-Speed Connector", "Manufacturer",
    { Quickwire: 36, Silica: 3, "Circuit Board": 3 }, { "High-Speed Connector": 1.5 }, { alt: true }),
  ...
  r("Crystal Oscillator", "Crystal Oscillator", "Manufacturer",
    { "Quartz Crystal": 18, Cable: 14, "Reinforced Iron Plate": 2.5 }, { "Crystal Oscillator": 1 }),
  r("Insulated Crystal Oscillator", "Crystal Oscillator", "Manufacturer",
    { "Quartz Crystal": 18.75, Rubber: 13.125, "AI Limiter": 16.875 }, { "Crystal Oscillator": 1.875 }, { alt: true }),

  r("Electromagnetic Control Rod", "Electromagnetic Control Rod", "Assembler",
    { Stator: 6, "AI Limiter": 4 }, { "Electromagnetic Control Rod": 4 }),

  // Radio Control Unit: standard (Manufacturer) vs alt Radio Control System
  r("Radio Control Unit", "Radio Control Unit", "Manufacturer",
    { "Aluminum Casing": 40, "Crystal Oscillator": 1.25, Computer: 2.5 }, { "Radio Control Unit": 2.5 }),
  r("Radio Control System", "Radio Control Unit", "Manufacturer",
    { "Crystal Oscillator": 1.5, "Circuit Board": 15, "Aluminum Casing": 7.5 }, { "Radio Control Unit": 4.5 }, { alt: true }),
  ...
  r("Heavy Encased Frame", "Heavy Modular Frame", "Manufacturer",
    ...
    { "Heavy Modular Frame": 2.8125 }, { alt: true }),
  r("Heavy Flexible Frame", "Heavy Modular Frame", "Manufacturer",
    ...
    { "Heavy Modular Frame": 3.75 }, { alt: true }),

  // ---------------- ALUMINUM ----------------
  r("Alclad Aluminum Sheet", "Alclad Aluminum Sheet", "Assembler",
    { "Aluminum Ingot": 30, "Copper Ingot": 10 }, { "Alclad Aluminum Sheet": 30 }),
  r("Aluminum Casing", "Aluminum Casing", "Constructor",
    { "Aluminum Ingot": 90 }, { "Aluminum Casing": 60 }),
  r("Cooling System", "Cooling System", "Blender",
    { "Heat Sink": 12, Rubber: 12, Water: 30, "Nitrogen Gas": 150 }, { "Cooling System": 6 }),
  r("Heat Sink", "Heat Sink", "Assembler",
    { "Alclad Aluminum Sheet": 37.5, "Copper Sheet": 22.5 }, { "Heat Sink": 7.5 }),
  ...
  r("Alumina Solution", "Alumina Solution", "Refinery",
    { Bauxite: 120, Water: 180 }, { "Alumina Solution": 120, Silica: 50 }),
  r("Sloppy Alumina", "Alumina Solution", "Refinery",
    { Bauxite: 200, Water: 200 }, { "Alumina Solution": 240 }, { alt: true }),
  ...
  r("Aluminum Ingot", "Aluminum Ingot", "Foundry",
    { "Aluminum Scrap": 90, Silica: 75 }, { "Aluminum Ingot": 60 }),
  r("Pure Aluminum Ingot", "Aluminum Ingot", "Smelter",
    { "Aluminum Scrap": 60 }, { "Aluminum Ingot": 30 }, { alt: true }),

  // ---------------- COPPER POWDER ----------------
  r("Copper Powder", "Copper Powder", "Constructor",
    { "Copper Ingot": 300 }, { "Copper Powder": 50 }),
  ...
  r("Petroleum Coke", "Petroleum Coke", "Refinery",
    { "Heavy Oil Residue": 40 }, { "Petroleum Coke": 120 }, { tier: 5 }),
  r("Compacted Coal", "Compacted Coal", "Assembler",
    { Coal: 25, Sulfur: 25 }, { "Compacted Coal": 25 }, { tier: 5 }),
  r("Turbofuel", "Turbofuel", "Refinery",
    { Fuel: 22.5, "Compacted Coal": 15 }, { Turbofuel: 18.75 }, { tier: 6 }),
  r("Empty Canister", "Empty Canister", "Constructor",
    { Plastic: 30 }, { "Empty Canister": 60 }, { tier: 5 }),
  r("Packaged Turbofuel", "Packaged Turbofuel", "Packager",
    { Turbofuel: 20, "Empty Canister": 20 }, { "Packaged Turbofuel": 20 }, { tier: 6 }),
  r("Empty Fluid Tank", "Empty Fluid Tank", "Constructor",
    { "Aluminum Ingot": 60 }, { "Empty Fluid Tank": 60 }, { tier: 7 }),
  r("Packaged Nitrogen Gas", "Packaged Nitrogen Gas", "Packager",
    { "Nitrogen Gas": 240, "Empty Fluid Tank": 60 }, { "Packaged Nitrogen Gas": 60 }, { tier: 7 }),

  // -- Reinforced Iron Plate --
  r("Adhered Iron Plate", "Reinforced Iron Plate", "Assembler",
    { "Iron Plate": 11.25, Rubber: 3.75 }, { "Reinforced Iron Plate": 3.75 }, { alt: true }),
  r("Bolted Iron Plate", "Reinforced Iron Plate", "Assembler",
    { "Iron Plate": 90, Screw: 250 }, { "Reinforced Iron Plate": 15 }, { alt: true }),

  // -- Iron Rod --
  r("Aluminum Rod", "Iron Rod", "Constructor",
    { "Aluminum Ingot": 7.5 }, { "Iron Rod": 52.5 }, { alt: true }),

  // -- Iron Plate --
  r("Coated Iron Plate", "Iron Plate", "Assembler",
    { "Iron Ingot": 37.5, Plastic: 7.5 }, { "Iron Plate": 75 }, { alt: true }),
  r("Steel Cast Plate", "Iron Plate", "Foundry",
    { "Iron Ingot": 15, "Steel Ingot": 15 }, { "Iron Plate": 45 }, { alt: true }),

  // -- Wire --
  r("Caterium Wire", "Wire", "Constructor",
    { "Caterium Ingot": 15 }, { Wire: 120 }, { alt: true }),
  r("Fused Wire", "Wire", "Assembler",
    { "Copper Ingot": 12, "Caterium Ingot": 3 }, { Wire: 90 }, { alt: true }),

  // -- Cable --
  r("Insulated Cable", "Cable", "Assembler",
    { Wire: 45, Rubber: 30 }, { Cable: 100 }, { alt: true }),
  r("Quickwire Cable", "Cable", "Assembler",
    { Quickwire: 7.5, Rubber: 5 }, { Cable: 27.5 }, { alt: true }),

  // -- Copper Sheet --
  r("Steamed Copper Sheet", "Copper Sheet", "Refinery",
    { "Copper Ingot": 22.5, Water: 22.5 }, { "Copper Sheet": 22.5 }, { alt: true }),

  // -- Rotor --
  r("Copper Rotor", "Rotor", "Assembler",
    { "Copper Sheet": 22.5, Screw: 195 }, { Rotor: 11.25 }, { alt: true }),
  r("Steel Rotor", "Rotor", "Assembler",
    { "Steel Pipe": 10, Wire: 30 }, { Rotor: 5 }, { alt: true }),

  // -- Modular Frame --
  r("Bolted Frame", "Modular Frame", "Assembler",
    { "Reinforced Iron Plate": 7.5, Screw: 140 }, { "Modular Frame": 5 }, { alt: true }),

  // -- Stator --
  r("Quickwire Stator", "Stator", "Assembler",
    { "Steel Pipe": 16, Quickwire: 60 }, { Stator: 8 }, { alt: true }),

  // -- Motor --
  r("Rigor Motor", "Motor", "Manufacturer",
    { Rotor: 3.75, Stator: 3.75, "Crystal Oscillator": 1.25 }, { Motor: 7.5 }, { alt: true }),

  // -- Steel Beam --
  r("Molded Beam", "Steel Beam", "Foundry",
    { "Steel Ingot": 120, Concrete: 80 }, { "Steel Beam": 45 }, { alt: true }),

  // -- Steel Pipe --
  r("Iron Pipe", "Steel Pipe", "Constructor",
    { "Iron Ingot": 100 }, { "Steel Pipe": 25 }, { alt: true }),
  r("Molded Steel Pipe", "Steel Pipe", "Foundry",
    { "Steel Ingot": 50, Concrete: 30 }, { "Steel Pipe": 50 }, { alt: true }),

  // -- Encased Industrial Beam --
  r("Encased Industrial Pipe", "Encased Industrial Beam", "Assembler",
    { "Steel Pipe": 24, Concrete: 20 }, { "Encased Industrial Beam": 4 }, { alt: true }),

  // -- Circuit Board --
  r("Caterium Circuit Board", "Circuit Board", "Assembler",
    { Plastic: 12.5, Quickwire: 37.5 }, { "Circuit Board": 8.75 }, { alt: true }),
  r("Electrode Circuit Board", "Circuit Board", "Assembler",
    { Rubber: 20, "Petroleum Coke": 40 }, { "Circuit Board": 5 }, { alt: true }),

  // -- Computer --
  r("Caterium Computer", "Computer", "Manufacturer",
    { "Circuit Board": 15, Quickwire: 52.5, Rubber: 22.5 }, { Computer: 3.75 }, { alt: true }),

  // -- Supercomputer --
  r("OC Supercomputer", "Supercomputer", "Assembler",
    { "Radio Control Unit": 6, "Cooling System": 6 }, { Supercomputer: 3 }, { alt: true }),

  // -- Quickwire --
  r("Fused Quickwire", "Quickwire", "Assembler",
    { "Caterium Ingot": 7.5, "Copper Ingot": 37.5 }, { Quickwire: 90 }, { alt: true }),

  // -- Radio Control Unit --
  r("Radio Connection Unit", "Radio Control Unit", "Manufacturer",
    { "Heat Sink": 15, "High-Speed Connector": 7.5, "Quartz Crystal": 45 },
    { "Radio Control Unit": 3.75 }, { alt: true }),

  // -- Smart Plating --
  r("Plastic Smart Plating", "Smart Plating", "Manufacturer",
    { "Reinforced Iron Plate": 2.5, Rotor: 2.5, Plastic: 7.5 }, { "Smart Plating": 5 }, { alt: true }),

  // -- Versatile Framework --
  r("Flexible Framework", "Versatile Framework", "Manufacturer",
    { "Modular Frame": 3.75, "Steel Beam": 22.5, Rubber: 30 }, { "Versatile Framework": 7.5 }, { alt: true }),
  ...
  r("Turbo Pressure Motor", "Turbo Motor", "Manufacturer",
    ...
    { "Turbo Motor": 3.75 }, { alt: true }),

  // -- Plastic / Rubber (the Recycled pair forms a cycle ONLY if BOTH are selected) --
  r("Recycled Plastic", "Plastic", "Refinery",
    { Rubber: 30, Fuel: 30 }, { Plastic: 60 }, { alt: true }),
  r("Recycled Rubber", "Rubber", "Refinery",
    { Plastic: 30, Fuel: 30 }, { Rubber: 60 }, { alt: true }),

  // -- Aluminum Casing --
  r("Alclad Casing", "Aluminum Casing", "Assembler",
    { "Aluminum Ingot": 150, "Copper Ingot": 75 }, { "Aluminum Casing": 112.5 }, { alt: true }),

  // -- Heat Sink --
  r("Heat Exchanger", "Heat Sink", "Assembler",
    { "Aluminum Casing": 30, Rubber: 30 }, { "Heat Sink": 10 }, { alt: true }),

  // -- Cooling System --
  r("Cooling Device", "Cooling System", "Blender",
    { "Heat Sink": 10, Motor: 2.5, "Nitrogen Gas": 60 }, { "Cooling System": 5 }, { alt: true }),

  // -- Diamond --
  r("Cloudy Diamonds", "Diamond", "Particle Accelerator",
    { Coal: 240, Limestone: 480 }, { Diamond: 20 }, { alt: true, power: 500 }),
  r("Petroleum Diamonds", "Diamond", "Particle Accelerator",
    { "Petroleum Coke": 720 }, { Diamond: 30 }, { alt: true, power: 500 }),
  r("Pink Diamonds", "Diamond", "Converter",
    { Coal: 120, "Quartz Crystal": 45 }, { Diamond: 15 }, { alt: true, power: 250 }),
  r("Turbo Diamonds", "Diamond", "Particle Accelerator",
    { Coal: 600, "Packaged Turbofuel": 40 }, { Diamond: 60 }, { alt: true, power: 500 }),

  // -- Dark Matter Crystal --
  r("Dark Matter Crystallization (Residue)", "Dark Matter Crystal", "Particle Accelerator",
    { "Dark Matter Residue": 200 }, { "Dark Matter Crystal": 20 }, { alt: true, power: 1000 }),
